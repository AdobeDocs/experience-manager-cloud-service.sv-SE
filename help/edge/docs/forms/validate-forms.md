...
Det adaptiva Forms-blocket har stöd för en mängd olika [HTML-5-indatatyper](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#input_types), bland annat text, e-post, nummer, datum och annat. Den innehåller även [textarea](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea), select och fieldsSet tillsammans med omfattande indatavalideringsfunktioner som är inbyggda i HTML-5.

använder HTML fälttyper för att definiera vilken typ av data en användare kan ange. Olika fälttyper har olika inbyggda valideringsregler:
