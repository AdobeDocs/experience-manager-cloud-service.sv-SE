...
AEM Forms tillhandahåller ett block, som kallas adaptivt formulärblock, som gör det enkelt att skapa formulär för att hämta in och lagra inhämtade data.
...
Med AEM Forms-mallen för mallar kommer du snabbt igång med ett AEM projekt som är förkonfigurerat med det adaptiva formulärblocket. Det är det snabbaste och enklaste sättet att följa AEM bästa praxis och börja skapa formulär.
...
1. Klicka **Använd den här mallen** och väljer **Skapa en ny databas** och välj var du vill skapa databasen.
   ![Skapa en ny databas med AEM Forms Boilerplate](/help/edge/assets/create-new-repository-using-aem-forms-boilerplate.png)

   Adobe rekommenderar att databasen är inställd på public. På skärmen Skapa en ny databas väljer du **public** alternativ.
...
1. Installera AEM Code Sync GitHub App på din databas. Installera:
   ...
   Grattis! Du har en ny webbplats på `https://<branch>--<repo>--<owner>.hlx.page/`. I exemplet ovan är det [https://main—weFinance—wkndforms.hlx.page/](https://main--wefinance--wkndforms.hlx.page/).
...
1. Dela mappen med Adobe Experience Manager-användaren (helix@adobe.com).
   ...
   ![Använd alternativet Hantera åtkomst för att dela mappen med AEM användare](/help/edge/assets/share-folder-with-aem-user.png)

   Se till att du har gett Adobe Experience Manager-användaren redigeringsbehörighet för mappen.

   ![Dela mapp med AEM användare, ange redigeringsbehörighet](/help/edge/assets/share-folder-with-aem-user-provide-editing-access.png)
...
1. Nu när du har konfigurerat innehållsmappen är det dags att länka den till ditt projekt på GitHub som du skapade med AEM Forms Boilerplate tidigare. Ansluta:
   ...
   1. Genomför den uppdaterade filen fsatb.yaml när du har uppdaterat referensen och allt ser bra ut. Detta sparar ditt arbete och ansluter innehållsmappen till webbplatsen.
      ...
      >
      >
      >När du har uppdaterat referensen kan felet&quot;404 Hittades inte&quot; uppstå från början. Det beror på att ditt innehåll inte har förhandsvisats än. I nästa avsnitt beskrivs hur du börjar redigera och förhandsgranska ditt innehåll.
...
Om du har ett befintligt AEM kan du integrera det adaptiva formulärblocket i det aktuella projektet för att komma igång med att skapa formulär. Integrera:

1. Klona databasen för adaptiva formulärblock: https://github.com/adobe-rnd/aem-boilerplate-forms till din dator.
