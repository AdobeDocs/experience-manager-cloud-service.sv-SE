...
+ AEM as a Cloud Service migreringsresa {#migration-journey}
   ...
   + Versionsinformation för migreringsverktyg {#release-notes-migration-tools}
      + [Aktuell versionsinformation (2022.1.0)](/help/journey-migration/release-notes/release-notes-migration-tools-current.md)
      + 2021 {#2021}
...
+ Sites {#sites}
   ...
   + Redigering {#authoring}
      ...
      + Grundläggande om redigering {#fundamentals}
         ...
         + [Experience Fragments - Exportera](/help/sites-cloud/authoring/fundamentals/experience-fragments-target.md)
