...
>
>Om du är AEM-administratör, en Cloud Manager-administratör, ansvarar både för frontend-utveckling och administratörsuppgifter, eller helt enkelt vill förstå hela processen i AEM för frontend-utveckling, fortsätter du att läsa det aktuella dokumentet och fortsätter på den här resan.

## Syfte {#objective}

I det här dokumentet får du hjälp att förstå hur verktyget Skapa AEM snabbwebbplats fungerar och du får en översikt över hela flödet. När du har läst bör du:
...
Den här delen av kundresan gäller både AEM-administratören och Cloud Manager-administratören.
...
Det är viktigt att förstå att det inte krävs någon tillgång till eller kunskap om AEM för den som utvecklar gränssnittet.
...
| Grundläggande kunskaper i hur man skapar och hanterar webbplatser i AEM | AEM-administratör |
...
| Tillgång till Admin Console | Cloud Manager Administrator |
...
För den som utvecklar fronten behöver AEM inte användas.
...
1. AEM-administratören loggar in i en AEM-miljö och skapar en ny webbplats med hjälp av en webbplatsmall.
1. Cloud Manager-administratören skapar en pipeline i Cloud Manager. I pipeline ordnas distributionen av kod från en Git-databas till en AEM-miljö.
1. AEM-administratören exporterar webbplatstemat från AEM-instansen av programmet och skickar det till klientutvecklaren.
...
Den största fördelen med att använda verktyget Skapa snabbwebbplats är att den renodlade utvecklaren bara ansvarar för själva anpassningen. Framtidsutvecklaren har ingen interaktion med AEM eller behöver någon kunskap om AEM.
...
Bygg vidare på den här kunskapen och fortsätt din resa till AEM Quick Site Creation genom att gå igenom dokumentet [Create Site from Template](create-site.md) där du får lära dig hur du snabbt skapar en ny AEM-webbplats med hjälp av en mall.
