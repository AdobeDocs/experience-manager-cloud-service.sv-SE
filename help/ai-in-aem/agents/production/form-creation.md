...
* **Skapa ett nytt formulär med en normal textfråga**: Du kan skapa varumärkesanpassade formulärupplevelser genom att skicka in dina krav på ett vanligt språk.

* **Importera en PDF eller bild och konvertera den till formulär**: Du kan importera och omvandla befintliga bilder eller PDF-dokument till formulär. Agenten analyserar överfört innehåll för att identifiera fälttyper, bevara layouter och förbättra formulär med responsiv design och valideringslogik. De format som stöds är bland annat Acrobat, XFA PDF-filer, platta PDF-filer, bilder (JPG, PNG) och handritade formulärfoton.
...
När du har skapat en ursprunglig formulärstruktur med hjälp av AI Assistant kan du använda Forms Creation Extension för att:
