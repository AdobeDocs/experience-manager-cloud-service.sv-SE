...
* **[Sömlöst samarbete med identifieringsagenten](/help/ai-in-aem/agents/discovery/overview.md)**: Bygger på de resurser som identifieras av identifieringsagenten, vilket möjliggör fullständig hämtning och optimering av resurser genom naturlig konversation.
...
* **Skapa återgivning med hög upplösning**
  ...
  Sök efter rätt resurs med [identifieringsagenten](/help/ai-in-aem/agents/discovery/overview.md) och använd sedan följande uppmaningar om det finns flera sökresultat:
