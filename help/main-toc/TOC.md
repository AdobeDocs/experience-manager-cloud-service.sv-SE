...
+ Kommunikations-API:er {#using-communications}
   + [Översikt över kommunikations-API:er](/help/forms/aem-forms-communication-api-overview.md)
   ...
   + [Autentisering JWT (JSON Web Token)](/help/forms/jwt-api-authentication.md)
