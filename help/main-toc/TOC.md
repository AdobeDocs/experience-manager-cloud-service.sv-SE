...
+ Dokumentskydd {#security}
   ...
   + [Konfigurera CDN- och WAF-regler för att filtrera trafik](/help/security/cdn-and-waf-rules.md)
...
+ Forms {#forms}
   ...
   + Integrera {#integrate}
      + Tjänster {#services}
         ...
         + [Integrera adaptiv Forms i Adobe Analytics](/help/forms/forms-experience-cloud-setup-automation.md)
