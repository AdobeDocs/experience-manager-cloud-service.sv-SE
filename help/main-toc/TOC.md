...
+ AI i AEM {#ai-in-aem}
   ...
   + Agenter i AEM {#agents}
      ...
      + Varumärkesupplevelseagent {#brand-experience}
         ...
         + [Utvecklingsjobb](/help/ai-in-aem/agents/brand-experience/development/development.md)
      + Agent för Content Advisor {#content-advisor}
         + [Ökning](/help/ai-in-aem/agents/content-advisor/overview.md)
         + [Innehållsupptäckt jobb](/help/ai-in-aem/agents/content-advisor/discovery.md)
         + [Innehållsoptimeringsjobb](/help/ai-in-aem/agents/content-advisor/content-optimization.md)
