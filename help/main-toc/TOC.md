...
+ Edge Delivery Services {#edge-delivery}
   ...
   + Building Forms {#build-forms}
      ...
      + WYSIWYG Authoring {#universal-editor}
         ...
         + [Guider Användare efter överföring: Konfigurera omdirigeringar och tackmeddelanden i Universell redigerare](/help/edge/docs/forms/universal-editor/configure-thankyou-message.md)
         ...
         + [Konfigurera förifyllningstjänsten: Slutför steg-för-steg-guiden för att konfigurera förifyllningstjänsten](/help/edge/docs/forms/universal-editor/prefill-form.md)
