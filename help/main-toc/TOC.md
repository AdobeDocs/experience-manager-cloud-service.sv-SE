...
+ AI i AEM {#ai-in-aem}
   ...
   + AEM Business Agents {#business-agents}
      ...
      + Produktionsagent {#production}
         + [Ökning](/help/ai-in-aem/agents/production/overview.md)
         + [Kunskap för att skapa interaktiv kommunikation](/help/ai-in-aem/agents/production/communications-creation.md)
      ...
      + Agent för innehållsoptimering {#content-optimization}
         + [Använda Content Optimization Agent](/help/ai-in-aem/agents/content-optimization/using.md)
      + Identifieringsagent {#discovery}
         + [Använda Discovery Agent](/help/ai-in-aem/agents/discovery/using.md)
