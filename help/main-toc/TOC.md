...
+ Generativ AI {#generative-ai}
   ...
   + [AI Assistant i AEM - Konfigurera](/help/implementing/cloud-manager/aem-ai-assistant-admin.md)
   + [AI Assistant i AEM (Beta)](/help/implementing/cloud-manager/aem-ai-assistant.md)
   + [AI Assistant i AEM Forms (Forms Experience Builder) (tidig Adobe)](/help/edge/docs/forms/forms-ai-assistant.md)
   + [AI Assistant i AEM Forms - promptbibliotek](/help/edge/docs/forms/ai-assistant-prompt-library.md)
   + [AI Assistant i AEM Forms - Komma igång](/help/edge/docs/forms/forms-ai-assistant-getting-started.md)
