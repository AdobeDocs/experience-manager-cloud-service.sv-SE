...
+ Dokumentskydd {#security}
   + [Säkerhet för AEM as a Cloud Service](/help/security/cloud-service-security-overview.md)
   + [Konfigurera OSGI för AEM as a Cloud Service](/help/security/configuring-advanced-networking.md)
   + [IMS-stöd för AEM as a Cloud Service](/help/security/ims-support.md)
   + [IMS-stöd för AEM as a Cloud Service](/help/security/same-site-cookie-support.md)
...
+ Introduktion till {#onboarding}
   ...
   + Onboarding Journey {#journey}
      ...
      + [Åtkomst till Cloud Manager ](/help/journey-onboarding/cloud-manager.md)
...
+ AEM as a Cloud Service migreringsresa {#migration-journey}
   ...
   + Cloud Acceleration Manager {#cloud-acceleration-manager}
      ...
      + Använda Cloud Manager {#using-cam}
   ...
   + Verktyg för övergång till molnet{#cloud-migration}
      ...
      + Content Transfer Tool {#content-transfer-tool}
         ...
         + [Köra verktyget Innehållsöverföring på en Publish-instans](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/running-content-transfer-tool-publish-instance.md)
         + [Hantera huvudkonton efter migrering](/help/journey-migration/managing-principals-after-migration.md)
         + [Använda Content Transfer Tool](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/troubleshooting-content-transfer-tool.md)
...
+ Sites {#sites}
   ...
   + Redigering {#authoring}
      + [Snabbstartsguide till redigering av sidor](/help/sites-cloud/authoring/quick-start.md)
      ...
      + [Sökning](/help/sites-cloud/authoring/search.md)
      + [Konfigurera kontomiljön](/help/sites-cloud/authoring/account-environment.md)
      ...
      + Sidredigeraren {#page-editor}
         ...
         + [Skapa tillgängligt innehåll (WCAG 2.1-överensstämmelse)](/help/sites-cloud/authoring/page-editor/accessible-content.md)
   ...
   + Administrerar {#administering}
      + Innehållsfragment {#content-fragments}
         ...
         + [Modeller för innehållsfragment](/help/sites-cloud/administering/content-fragments/setup.md)
         ...
         + [Variationer – redigera innehållsfragment](/help/sites-cloud/administering/content-fragments/authoring.md)
      ...
      + Skapa webbplats {#site-creation}
         ...
         + AEM snabbplatsskapande resa {#quick-site}
            ...
            + [Åtkomst till Cloud Manager ](/help/journey-sites/quick-site/cloud-manager.md)
      ...
      + Återanvänder innehåll {#reusing-content}
         ...
         + Multi Site Manager {#msm}
            ...
            + [SEO-metodtips ](/help/sites-cloud/administering/msm/best-practices.md)
         ...
         + Översättning {#translation}
            ...
            + [SEO-metodtips ](/help/sites-cloud/administering/translation/best-practices.md)
   ...
   + Integrera med AEM as a Cloud Service {#integrations}
      ...
      + [Integrera med Adobe Target](/help/sites-cloud/integrating/campaign.md)
...
+ Assets {#assets}
   ...
   + [Integrera AEM Assets när du skapar material för Edge Delivery Services](/help/assets/integrate-aem-assets-edge-delivery-services.md)
   + Hantera digitala resurser {#manage}
      + Mikrofrontsväljare för resurs {#asset-selector}
         ...
         + Integrering av resursväljare {#asset-selector-integration}
            ...
            + [Integrera resursväljaren med ett Adobe-program](/help/assets/integrate-asset-selector-adobe-app.md)
      ...
      + [AEM Assets](/help/assets/reprocessing.md)
      ...
      + [AEM Assets](/help/assets/download-assets-from-aem.md)
      ...
      + [Hantera rättigheter för digitala resurser](/help/assets/drm.md)
      + [AEM Assets](/help/assets/watermark-assets.md)
   ...
   + Konfigurera, administrera och utöka Assets [!DNL Assets]{#admin}
      ...
      + [AEM Assets](/help/assets/translate-assets.md)
   ...
   + Dela och driftsätta resurser {#brand-portal}
      ...
      + [Publicera resurser nu  [!DNL Brand Portal]](/help/assets/publish-to-brand-portal.md)
   ...
   + Dynamic Media {#dynamicmedia}
      ...
      + [Dynamic Media-nyhetsbrev från Experience League](/help/assets/dynamic-media/dynamic-media-newsletter.md)
      + [Installera Dynamic Media](/help/assets/dynamic-media/administering-dynamic-media.md)
      ...
      + [Publicera Dynamic Media-resurser](/help/assets/dynamic-media/managing-assets.md)
      ...
      + [Använda förinställningar för Dynamic Media-bilder](/help/assets/dynamic-media/managing-image-presets.md)
      + [Använda förinställningar för Dynamic Media-bilder](/help/assets/dynamic-media/image-presets.md)
      + [Använda förinställningar för Dynamic Media Viewer](/help/assets/dynamic-media/managing-viewer-presets.md)
      ...
      + [Publicera Dynamic Media-resurser](/help/assets/dynamic-media/delivering-dynamic-media-assets.md)
      ...
      + [Dynamic Media-konfiguration](/help/assets/dynamic-media/limitations.md)
      ...
      + [Publicera Dynamic Media-resurser](/help/assets/dynamic-media/previewing-assets.md)
      + [Lägga till Dynamic Media-resurser på sidor](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)
      + [Bädda in läsare för Dynamic-video eller -bilder på en webbsida](/help/assets/dynamic-media/embed-code.md)
      ...
      + [Omforma URL:er med regeluppsättningar](/help/assets/dynamic-media/using-rulesets-to-transform-urls.md)
      ...
      + [Meddelande om att Flash Viewer har upphört](/help/assets/dynamic-media/flash-viewers-eol.md)
      ...
      + Dynamic Media med OpenAPI-funktioner {#dynamic-media-open-apis}
         ...
         + [AEM Assets](/help/assets/approve-assets.md)
         ...
         + [Vanliga frågor](/help/assets/dynamic-media-open-apis-faqs.md)
   ...
   + Arbeta med Assets-vyn {#assets-view}
      ...
      + [AEM Assets](/help/assets/navigate-assets-view.md)
      ...
      + [Vanliga åtgärder för hantering av material](/help/assets/manage-organize-assets-view.md)
   ...
   + Bästa praxis {#best-practices}
      + [SEO-metodtips ](/help/assets/search-best-practices.md)
...
+ Forms {#forms}
   + Översikt {#forms-overview}
      ...
      + [Viktiga ändringar ](/help/forms/notable-changes.md)
   ...
   + Konfigurera och migrera {#setup-configure-migrate}
      ...
      + [Listor för åtkomstkontroll och behörighet](/help/forms/forms-groups-privileges-tasks.md)
   ...
   + Adaptiv Forms {#adaptive-forms-authoring}
      ...
      + Foundation Components {#authoring-adaptive-forms-foundation-components}
         + 2. Konvertera PDF-formulär till anpassningsbara formulär {#afcs}
   ...
   + Transaktionsrapporter {#using-communications}
      ...
      + [Förstå instrumentpanelen för värdeutjämning](/help/forms/aem-forms-value-realization-dashboard.md)
...
+ Screens {#screens-as-cloud-service}
   + Översikt över AEM as a Cloud Service{#overview}
   ...
   + Onboarding för AEM as a Cloud Service{#onboarding-screens-cloud}
      ...
      + [Skapa ett program](/help/screens-cloud/onboarding-screens-cloud/creating-a-branch.md)
   ...
   + Konfigurerar Screens as a Cloud Service Project {#configure-screens-cloud}
      ...
      + [Konfigurera OSGI för AEM as a Cloud Service](/help/screens-cloud/configuring/dispatcher-configurations-screens-cloud.md)
      + [Konfigurera OSGI för AEM as a Cloud Service](/help/screens-cloud/configuring/configuring-timeline-view-screens.md)
   ...
   + Utveckla för AEM as a Cloud Service {#developing-screens-cloud}
   ...
   + [Screens - frågor och svar](/help/screens-cloud/screens-cloud-faqs.md)
+ Innehåll och Commerce {#content-and-commerce}
   + [Introduktion och översikt](/help/commerce-cloud/introduction.md)
   + [Viktiga ändringar i AEM Sites as a Cloud Service](/help/commerce-cloud/changes.md)
   + Commerce KB{#journeys}
   ...
   + AEM Storefront {#storefront}
      ...
      + Redigering {#authoring}
         + [Commerce KB](/help/commerce-cloud/authoring/authoring-commerce-experiences.md)
...
+ Edge Delivery Services{#edge-delivery}
   ...
   + Dokumentbaserad redigering {#document-authoring}
      ...
      + [XMP-metadata](/help/edge/docs/bulk-metadata.md)
   ...
   + Edge Delivery Services{#resources}
      + Sidekick {#sidekick}
...
+ Headless {#headless}
   ...
   + Konfigurera {#setup}
      ...
      + [Modeller för innehållsfragment](/help/headless/setup/create-content-model.md)
   ...
   + [Stöd för Content Fragments i AEM Assets HTTP API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/assets-api-content-fragments.html)
   + Dokumentskydd {#security}
...
+ Implementera {#implementing}
   ...
   + Åtkomst till Cloud Manager {#using-cloud-manager}
      ...
      + {#create-application-project}Skapa ett AEM-programprojekt
      ...
      + [miljö-ID](/help/implementing/cloud-manager/environment-variables.md)
      ...
      + {#test-results}Förstå testresultat
         ...
         + [Förstå regler för anpassad kodkvalitet](/help/implementing/cloud-manager/custom-code-quality-rules.md)
      ...
      + Edge Delivery Services{#edge-delivery-sites}
      ...
      + [Dokumentation om Cloud Manager](/help/implementing/cloud-manager/faqs.md)
   ...
   + Konfigurera och utöka AEM as a Cloud Service {#configuring-and-extending}
      + Utöka AEM med App Builder {#app-builder}
         ...
         + [Skapa en målgrupp](/help/implementing/developing/extending/app-builder/videos/create.md)
...
+ Kompatibilitet {#compliance}
   + [CDN i AEM as a Cloud Service](/help/compliance/home.md)
