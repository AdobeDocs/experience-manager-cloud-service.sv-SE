...
När du öppnar ditt innehållsfragment för redigering visas **Variationer** som standard är öppen. Här kan du skapa innehåll, för Överordnad eller andra varianter som du har. Det strukturerade fragmentet innehåller olika fält, av olika datatyper, som har definierats i innehållsmodellen.
