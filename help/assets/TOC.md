...
+ [AEM Assets som molntjänst](/help/assets/home.md)
+ [Översikt och nyheter](overview.md)
+ [Viktiga ändringar i AEM Assets som molntjänst](assets-cloud-changes.md)
+ [Arkitektur](architecture.md)
+ [Filformat som stöds](file-format-support.md)
+ [Översikt över mikrotjänster för material](asset-microservices-overview.md)
+ Hantera digitalt material med AEM {#manage}
   + [Dela material](share-assets.md)
   ...
   + [Lägga till och överföra material](add-assets.md)
   + [Söka efter material](search-assets.md)
   + [Vanliga åtgärder för hantering av material](manage-digital-assets.md)
   + [Smarta taggar](smart-tags.md)
   + [Organisera material](organize-assets.md)
...
+ Konfigurera, administrera och utöka Assets {#admin}
   ...
   + [Flerspråkigt material och översättning av material](translate-assets.md)
...
+ Dynamic Media {#dynamicmedia}
   ...
   + [Hantera Dynamic Media-material](dynamic-media/managing-assets.md)
   ...
   + [Förhandsgranska Dynamic Media-material](dynamic-media/previewing-assets.md)
   + [Lägga till Dynamic Media-material på sidor](dynamic-media/adding-dynamic-media-assets-to-pages.md)
   ...
   + [Publicera Dynamic Media-material](dynamic-media/publishing-dynamicmedia-assets.md)
