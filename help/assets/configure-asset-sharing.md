...
1. Klicka på eller tryck på AEM-logotypen och gå sedan till **[!UICONTROL Verktyg]** > **[!UICONTROL Åtgärder]** > **[!UICONTROL Webbkonsol]**.
1. Leta upp **[!UICONTROL Dag CQ Mail Service]** i listan över tjänster.
1. Klicka på ikonen **[!UICONTROL Redigera]** bredvid tjänsten och konfigurera följande parametrar för **Day CQ Mail Service]** med de uppgifter som anges för deras namn:
...
1. Klicka på/tryck på AEM-logotypen och gå sedan till **Verktyg** > **Åtgärder** > **Webbkonsol**.
1. På webbkonsolen går du till **Day CQ DAM Adhoc Asset Share Proxy Server** .
1. Öppna **Dag CQ DAM Adhoc Asset Share Proxy Server** i redigeringsläge och ändra värdet för parametern **Max Content Size (okomprimerad)** .
1. Spara ändringarna.
