...
I den här artikeln beskrivs det kompletta arbetsflödet för att aktivera Prime- och Ultimate-erbjudanden för [!DNL Dynamic Media].
...
1. Välj **[!UICONTROL Click to activate]** på raden **[!UICONTROL Dynamic Media]** i avsnittet **[!UICONTROL Environment Information]** på sidan Miljöinformation.
   ![aktivera dynamiska media med OpenAPI-funktioner](/help/assets/assets/activate-adv-capabiliites-of-dm-openAPI.png){width="700" align="center"}
...
* ![DM har aktiverats ](/help/assets/assets/Images_icon.svg)**[!UICONTROL Dynamic Media]**:**[!UICONTROL OpenAPI capabilities failed to activate]**  ![försök aktivera igen](/help/assets/assets/retry-dm-openapi-failed-activation.png){width="700" align="center"}
