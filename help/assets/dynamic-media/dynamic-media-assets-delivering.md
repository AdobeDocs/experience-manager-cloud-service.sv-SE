...
* Om webbplatsen inte finns på Experience Manager läser du [Leverera Dynamic Media Assets](/help/assets/dynamic-media/delivering-dynamic-media-assets.md) i det beröringsaktiverade användargränssnittet.
