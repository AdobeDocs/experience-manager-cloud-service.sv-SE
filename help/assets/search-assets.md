...
### Aktivera eller inaktivera AI-sökning i administratörsvyn {#enable-disable-ai-search}

Utför följande steg för att aktivera eller inaktivera AI-sökning i administratörsvyn:
...
1. I avsnittet **[!UICONTROL Search]** väljer du **[!UICONTROL AI Search]** för att aktivera AI-sökning eller **[!UICONTROL Keyword]** för att inaktivera den.
   ...
   ![Aktivera eller inaktivera AI-sökning](/help/assets/assets/enable-ai-search-admin-view.png)
