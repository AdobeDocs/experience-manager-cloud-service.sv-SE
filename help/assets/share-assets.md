...
1. Markera eller avmarkera **[!UICONTROL Link Settings]** eller `Include Originals` under `Include Renditions` om du vill inkludera eller exkludera någon av de två. Du måste välja minst ett alternativ.
