...
Du kan skapa en ny konfiguration på Adobe I/O för att konfigurera AEM Assets med varumärkesportalen.
...
* [Publicera resurser från AEM Assets till varumärkesportalen](publish-to-brand-portal.md#publish-assets-to-bp)
...
Distributionen innehåller följande loggar:
