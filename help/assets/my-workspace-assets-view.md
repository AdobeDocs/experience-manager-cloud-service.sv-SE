...
The **[!UICONTROL Top Downloads]** På -fliken visas de tio mest hämtade resurserna som finns i resursvyn. Du kan välja att visa resurser i listvyn eller stödrastervyn. Båda vyerna visar formattyp och antal hämtningar för varje resurs. Du kan också välja en resurs och klicka på **[!UICONTROL Details]** för att visa dess egenskaper.
