...
Innan du skickar in en begäran om att aktivera Dynamic Media med OpenAPI-funktioner på AEM as a Cloud Service ska du kontrollera att det inte redan är aktiverat.
