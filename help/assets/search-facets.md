...
1. Tryck **[!UICONTROL Delete]** ![ta bort ikon](assets/do-not-localize/deleteoutline.png) i verktygsfältet.
1. Tryck på **[!UICONTROL Delete]** för att ta bort de anpassade ändringarna.
