...
| `cacheNames` | De här värdena definieras under motsvarande CIF GraphQL-klientkonfigurationsfabrik >> Motsvarande StorePath GraphQL-konfiguration >> GraphQL cachekonfigurationer | Array | Nej | |
