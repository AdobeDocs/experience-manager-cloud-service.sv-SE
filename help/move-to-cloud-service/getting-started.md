...
1. [Verktyget](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/content-transfer-tool.html?lang=en#migration)  Innehållsöverföring: används för att flytta befintligt innehåll från en AEM (lokal eller AMS) till AEM Cloud Service-målinstansen.
