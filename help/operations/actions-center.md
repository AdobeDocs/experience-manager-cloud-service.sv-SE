...
| S2S-certifikatet förfaller | Proaktiv | Lär dig hur du uppdaterar en autentiseringsuppgift i [Genererar åtkomsttoken för API:er på serversidan](/help/implementing/developing/introduction/generating-access-tokens-for-server-side-apis.md#refresh-credentials) |
| Högt antal anslutningar | Proaktiv | Lär dig mer om anslutningspoolning i [Anslutningspoolning tillsammans med dokumentationen för avancerat nätverk](/help/security/configuring-advanced-networking.md#connection-pooling-advanced-networking) |
...
| Fråga utan index | Proaktiv | Undvik att köra en fråga som inte använder ett index - [länk till indexeringsdokumentation](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/operations/indexing) |
