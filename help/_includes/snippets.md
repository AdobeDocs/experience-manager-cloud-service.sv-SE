...
<table>
  ...
  <tr>
    ...
    <td>Listrutan med alternativ anges med regelredigerarens <b>Invoke Service</b> -egenskap. 
   </td>
   </tr>
     </tr>
   <tr>
   ...
   <tr>
    <td>Stöd för ECMAScript-versioner</td>
    <td>Stöder endast ES5 JavaScript-funktioner.</td>
    <td>Stöder moderna JavaScript-funktioner (t.ex. <code>let</code>, pilfunktioner) inom anpassade funktioner.</td>
   </tr>
   </tr>
   <tr>
...
>
>* [Den universella redigeraren](https://www.aem.live/docs/aem-authoring) för visuell redigering av headless-innehåll.
...
Adobe har ett antal mallar som är anpassade för olika syften, vilket snabbar upp framtagningen av webbplatser.

* [AEM Site with Edge Delivery Services](https://github.com/adobe-rnd/aem-boilerplate-xwalk/releases) - För att skapa AEM-sidor med Universal Editor och leverera genom [edge-leverans](/help/edge/overview.md)
* [Edge Delivery Services med AEM Authoring for Commerce](https://github.com/adobe-rnd/aem-boilerplate-xcom/releases) - För utveckling av AEM-sidor med Universal Editor för e-handelsprojekt och leverans via [edge-leverans](/help/edge/overview.md)
* [Standardmall för AEM-webbplatser](https://github.com/adobe/aem-site-template-standard/releases) - För redigering av traditionella AEM-sidor och leverans via [publiceringsleverans](/help/sites-cloud/authoring/author-publish.md)
