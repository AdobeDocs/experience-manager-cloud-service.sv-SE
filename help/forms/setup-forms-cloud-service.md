...
# Anlita [!DNL AEM Forms] as a Cloud Service {#overview}
...
<!-- When you sign up for the service, Adobe creates an Organization identifier for your company in the Adobe Identity Management System (IMS), where your users and their permissions can be managed. So, --> Innan du går med i en Adobe Experience Manager (AEM) Forms as a Cloud Service-miljö måste du bestämma dig för vilka personer du ska arbeta och strukturera ett team för ditt projekt. Ett typiskt [!DNL AEM Forms]-projektteam har följande profiler:
...
* **AEM-administratör**: En AEM-administratör kan hjälpa till med den övergripande konfigurationen, som att konfigurera användare, göra miljön skarpare, konfigurera datakällor, konfigurera e-post och tredjepartsprogram. AEM-administratören kan också hjälpa till med integreringar som integrering med Adobe Analytics, Adobe Target och Adobe Sign.
...
* [Anmäl dig](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/onboarding/journey/overview.html?lang=sv-SE) till [!DNL Adobe Experience Manager] as a Cloud Service.
...
När du är klar med introduktionen av tjänsten loggar du in på din [!DNL AEM Forms] as a Cloud Service-miljö, öppnar Författare och Publicera instanser och lägger till användare i Forms-specifika [AEM-grupper](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/accessing/aem-users-groups-and-permissions.html?lang=sv-SE#accessing), baserat på deras personliga profil. I följande tabell visas Forms-specifika AEM-grupper, som finns i kartongen, och motsvarande användartyper. Tabellen innehåller även AEM-instanstyp för varje användartyp:

| Användartyper (personas) | Användargrupper | AEM, instans |
|---|---|---|
...
Mer information om Forms-specifika AEM-grupper och motsvarande behörigheter finns i [Grupper och behörigheter](forms-groups-privileges-tasks.md).
