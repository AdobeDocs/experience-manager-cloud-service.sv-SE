---
title: Vad är adaptiva Forms-reserverade nyckelord?
description: Reserverade nyckelord som du inte kan använda som identifierare i din adaptiva Forms.
...
# Adaptiva Forms-nyckelord {#adaptive-forms-keywords}

Adaptiva Forms-nyckelord är fördefinierade, reserverade identifierare som har en speciell betydelse för Adaptiv Forms. Du kan inte använda dessa nyckelord som identifierare i din adaptiva Forms. I följande tabell visas alla nyckelord som är reserverade identifierare för Adaptive Forms.
