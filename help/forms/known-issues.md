---
title: Vilka är de kända problemen och begränsningarna i AEM Forms as a Cloud Service?
description: Kända fel och begränsningar i  [!DNL AEM Forms] as a Cloud Service-miljön.
...
* Lägg inte till och kör ett test som skickar ett adaptivt formulär från en publiceringsinstans till ett AEM Workflow som körs på en Author-instans förrän du får mer information.
...
* Steg **[!UICONTROL Set variable]** i AEM Workflows stöder inte variabler av typen matrislista. Du kan använda processsteget för att ange variabler för typmatrislistan.

* När du skickar ett adaptivt formulär som innehåller ett vanligt överföringsfält från HTML från en Apple iOS-enhet skickas inte filens innehåll och en 0 byte-fil tas emot i den andra änden. Problemet inträffar då och då endast när synkron överföring används. Detta är ett [känt fel](https://feedbackassistant.apple.com/feedback/9117687) i Apple iOS.
