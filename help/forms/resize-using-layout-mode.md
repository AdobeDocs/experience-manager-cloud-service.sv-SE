...
1. Växla till [!UICONTROL Layout] läge och välj [!UICONTROL Table] -komponenten. De blå punkter som komponentvisningen ska ändra storlek på i kolumnerna 1 och 12.
...
1. På samma sätt väljer du [!UICONTROL Image] och dra den blå punkten i kolumn 1 till kolumn 7 i det responsiva rutnätet. Tabellen och bildkomponenterna visas parallellt med varandra.
   ...
   Du kan markera bildkomponenten och välja **[!UICONTROL Float to new line]** som finns i verktygsfältet för att flytta bildkomponenten till nästa rad.
...
1. I **[!UICONTROL Edit]** läge, markera panelen, markera ![Konfigurera](assets/configure-icon.svg)och markera **[!UICONTROL Responsive - everything on the page without navigation]** från **[!UICONTROL Panel Layout]** listruta.
...
1. Välj **[!UICONTROL Yes]** för att aktivera **[!UICONTROL Layout]** formulärets läge.
...
Om du vill aktivera layoutläget väljer du **[!UICONTROL Layout]** från listrutan som visas högst upp bredvid **[!UICONTROL Preview]** välj **[!UICONTROL Yes]** för att bekräfta. Välj **[!UICONTROL Edit]** för att bädda in fragmentet igen.
