...
description: Vanliga frågor om Forms as a Cloud Service
...
Nej, steget Verifiera är inte tillgängligt för [!DNL Forms] as a Cloud Service. Ta bort verifieringssteget från din befintliga adaptiva Forms innan du flyttar sådana formulär till en Cloud Service-miljö.
...
Du kan ansluta en formulärdatamodell till [!DNL RESTful web services], [!DNL SOAP-based web services], [!DNL OData services] och Experience Manager-användarprofil som datakällor. <!--Support to connect a Form Data Model with a relational database is not available.-->
