...
>[!NOTE]
>
>Om ditt adaptiva Forms är inbäddat på AEM Sites-sidor kan du använda ett tema för både webbplatsen och formulären genom att bädda in ett adaptivt Forms-tema i ditt webbplatstema. Se [Bädda in ett adaptivt Forms-tema i ett AEM Sites-tema](/help/forms/embed-adaptive-forms-theme-in-site-theme.md).
...
>[!NOTE]
>
>Det här steget gäller när du distribuerar temat som ett **fristående**-paket via frontendpipelinen (t.ex. en dedikerad Forms-temarepresentation). Om du **bäddar in** Forms-temat i ditt AEM Sites-tema behöver du inte ange ett separat temanamn eller en separat version för formulärtemat. Webbplatstemats temanamn används. Se [Bädda in ett adaptivt Forms-tema i ett AEM Sites-tema](/help/forms/embed-adaptive-forms-theme-in-site-theme.md).
...
* [Bädda in ett adaptivt Forms-tema i ett AEM Sites-tema](/help/forms/embed-adaptive-forms-theme-in-site-theme.md)
