...
1. Välj ett program och klicka på **[!UICONTROL Create]**. Det adaptiva formulär som är kopplat till programmet öppnas. Fyll i informationen i det adaptiva formuläret och tryck på **[!UICONTROL Submit]**. Det startar det associerade arbetsflödet och skapar en uppgift i den tilldelades inkorg.
