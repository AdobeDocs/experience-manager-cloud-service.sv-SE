...
# Skicka åtgärd för Adaptiv Forms baserat på grundkomponenter
...
[Adaptiv Forms baserad på Foundation Component](/help/forms/creating-adaptive-form.md) har stöd för olika [körklara överföringsåtgärder](#submit-actions-supported-by-adaptive-forms-based-on-foundation-components). En Skicka-åtgärd utlöses när en användare klickar på knappen **[!UICONTROL Submit]** i ett anpassat formulär.

## Skicka funktionsmakron för Forms baserat på Foundation Components

Följande Skicka-åtgärder stöds av Adaptive Forms som bygger på Foundation Components:
...
Du kan också skicka ett adaptivt formulär baserat på Foundation Components till andra lagringskonfigurationer:
...
Dessutom kan du [anpassa standardinställningen för Skicka-åtgärder](/help/forms/custom-submit-action-form.md) så att den överensstämmer med specifika organisatoriska krav.

### Konfigurera en Skicka-åtgärd för formulär baserat på Foundation-komponenter
