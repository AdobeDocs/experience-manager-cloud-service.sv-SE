...
Releasedatum [!DNL Adobe Experience Manager] som [!DNL Cloud Service] aktuell version (2023.1.0) är 9 februari 2023. Nästa version (2023.2.0) är planerad till 30 mars 2023.
