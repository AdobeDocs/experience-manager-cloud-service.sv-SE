...
# Versionsinformation 2026.2.0 för [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

I följande avsnitt beskrivs versionsinformationen för funktionen för 2026.2.0-versionen av [!DNL Experience Manager] as a Cloud Service.
