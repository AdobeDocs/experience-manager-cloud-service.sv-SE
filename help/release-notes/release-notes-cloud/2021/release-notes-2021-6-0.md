...
* Detta gör att befintliga AEM Cloud Service-kunder kan skaffa XML-dokumentationstillägg för att importera, skapa, hantera och leverera tekniskt innehåll i flera kanaler, inklusive AEM webbplatser
