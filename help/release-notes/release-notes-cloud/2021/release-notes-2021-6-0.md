...
>[!NOTE]
>Se [AEM Screens as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/screens-as-cloud-service/home.html) Guide för grundläggande kunskaper som krävs för att installera, konfigurera och köra Screens as a Cloud Service samt länka till detaljerad teknisk dokumentation om koncept.
