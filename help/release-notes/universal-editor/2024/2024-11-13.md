...
* **Utökningsförbättringar för utvecklare:** Den universella redigeraren har nu stöd för sändning av händelser till tillägg, vilket gör att tilläggsutvecklare kan prenumerera på [händelser](/help/implementing/universal-editor/events-universal-editor.md).
