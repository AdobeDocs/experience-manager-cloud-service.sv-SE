...
### Oändringsbara OSGi-egenskaper {#unmodifiable-osgi-properties}

Det går inte att ändra egenskaperna för följande OSGi-komponent-PID:n, enligt beskrivningen nedan.
...
I framtiden kommer Adobe att tillämpa följande OSGi-egenskapsbegränsningar, så användningen bör stoppas.
