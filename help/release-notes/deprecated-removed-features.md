...
>[!IMPORTANT]
>
>Flera [föråldrade API:er](#aem-apis) tas bort den 4 maj 2026 **.** Se dessa viktiga datum och effekter:
>
...
>* **4 maj 2026**: Miljöer som fortfarande använder inaktuella API:er **kommer inte att få viktiga Adobe-uppdateringar** och omfattas inte av Adobe standardåtaganden om prestanda och tillgänglighet. Du får alltså inga nya funktioner eller felkorrigeringar, programstabiliteten och drifttiden kan påverkas negativt och säkerhetsriskerna kan öka ytterligare.
>
...
| [!DNL Assets] | Det går inte att dela [!DNL Assets] med tjänsten Assets Core och Creative Cloud. | Använd [!DNL Adobe Creative Cloud]Adobe Asset Link[&#x200B; för integrering med &#x200B;](https://helpx.adobe.com/enterprise/using/adobe-asset-link.html). | Borttagen |
...
<td>org.apache.felix.webconsole<br>org.apache.felix.webconsole.bundleinfo<br>org.apache.felix.webconsole.i18n<br>org.apache.felix.webconsole.spi</td>
  ...
  <tr>
    ...
    <td>Detta API är inaktuellt.</td>
    <td>07/10/2024</td>
    <td>9/30/2026</td>
  </tr>
  <tr>
    <td>com.day.cq.mailer.commons</td>
    <td>Detta API är föråldrat eftersom det är beroende av Commons-lang (som har tagits bort sedan 2021).</td>
    <td>11/30/2025</td>
    <td>9/30/2026</td>
  </tr>
  <tr>
    <td>com.adobe.granite.httpcache.api</td>
    <td>Detta API stöds inte längre.</td>
    <td>01/01/2026</td>
    <td>9/30/2026</td>
  </tr>
  <tr>
...
<td>org.apache.commons.lang<br>org.apache.commons.lang.enums<br>org.apache.commons.lang.builder<br>org.apache.commons.lang.exception<br>org.apache.commons.lang.math<br>org.apache.commons.lang.mutable<br>org.apache.commons.lang.reflect<br>org.apache.commons.lang.text<br>org.apache.commons.lang.time</td>
  ...
  <tr>
    ...
    <td>OSGi Service HTTP API är föråldrat. Använd OSGi Servlet Whiteboard i stället.</td>
    <td>5/1/2024</td>
    <td>12/31/2027 (Preliminärt)</td>
  </tr>
  </tbody>
...
Om du bestämmer dig för att distribuera din egen version av det inaktuella API:t, t.ex. din egen version av Guava, måste du se till att alla dina paket som använder detta API är kopplade till din version. Om du bestämmer dig för att distribuera samma större version som den som finns i Cloud Service behöver du inte göra något. Om du följer rekommendationerna och distribuerar den senaste versionen måste du dock justera Maven-projektet, inkludera det biblioteket som ett nytt beroende före `aem-sdk-api`. På så sätt kopplas koden till den nya versionen. När du har gjort ändringarna bör du kontrollera med [AEM as a Cloud Service SDK Build Analyzer Maven Plugin](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/developing/archetype/build-analyzer-maven-plugin) att användningen av det inaktuella API:t inte längre är flaggad.
