...
I följande avsnitt beskrivs den tekniska versionsinformationen för underhållsversionerna av Experience Manager as a Cloud Service som är kopplad till aktivering av funktioner i 2023.8.0.
...
2023.8.0 Funktionsaktivering innehåller alla funktioner som finns i den här underhållsversionen. Mer information finns i [Experience Manager Releases Roadmap](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html).
...
- CQ-4354191: Arbetsflöden - Anpassad startfunktion kan utlösas många gånger på grund av replikeringsmetadata som finns på nt:unstructured-noder (tillfällig lösning: startprogram för uppdatering som utesluter egenskaper för replikeringsmetadata för att undvika överlappning).
...
| Grundläggande komponenter i AEM | Version 2.23.2 | [AEM WCM Core Components](https://github.com/adobe/aem-core-wcm-components) |
...
- ASSETS-26533: Korrigerat ett fel i InDesign Server Integration som kan leda till timeout för långa bearbetningsbegäranden
...
- ASSETS-26576: Ett problem med Dropbox Import där den felaktiga mapphierarkin skapades har korrigerats
...
- GRANITE-46601: Korrigerat ett fel som hindrade QuickStart SDK från att starta JDK 11.0.20
...
- SKYOPS-61484: Korrigerade ett fel i tjänsten RDEProvider som medgav att oersättliga ${sling.home}-tokens kunde finnas kvar i sammanslagna OSGi-konfigurationer
