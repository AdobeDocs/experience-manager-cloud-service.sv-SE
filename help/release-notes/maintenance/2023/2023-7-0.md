...
I följande avsnitt beskrivs den tekniska versionsinformationen för underhållsversionerna av Experience Manager as a Cloud Service som är kopplad till aktivering av funktioner i 2023.7.0.
...
2023.7.0 Funktionsaktivering innehåller alla funktioner som finns i den här underhållsversionen. Mer information finns i [Experience Manager Releases Roadmap](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html).
...
- DXML-12327: AEM Guides: Stöd för språkvariabler vid publicering i PDF
- DXML-11518: AEM Guides: Förbättrat stöd för metadata i PDF-publicering
...
- DXML-10141: AEM Guides: Alternativ för användning av mikrotjänstbaserad publicering för PDF (Native &amp; DITA-OT), HTML och anpassade förinställningstyper
...
- AEM Guides: Olika förbättringar och stabilitetskorrigeringar för PDF
...
- SKYOPS-57146: Åtgärda dödläget vid start av AEM
...
- FORMS-8300: När en användare försöker delegera en uppgift efter att ha öppnat den, läser delegatsvaret in uppgiften igen, i stället för att öppna användarens AEM Inbox-gränssnitt.
...
- FORMS-8668: När du återger en PDF-förhandsgranskning av ett formulär visas en del Java™-stackdumpar som inte behövs i felloggarna. Det finns dock inga problem med att återge formuläret.
