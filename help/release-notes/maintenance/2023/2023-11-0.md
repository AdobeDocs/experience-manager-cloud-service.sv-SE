---
title: Underhållsversionsinformation för  [!DNL Adobe Experience Manager] as a Cloud Service som är kopplad till aktivering av funktioner i 2023.11.0.
description: Underhållsversionsinformation för  [!DNL Adobe Experience Manager] as a Cloud Service som är kopplad till aktivering av funktioner i 2023.11.0.
...
I följande avsnitt beskrivs den tekniska versionsinformationen för underhållsversionerna av Experience Manager as a Cloud Service som är kopplad till aktivering av funktioner i 2023.11.0.
...
2023.11.0 Funktionsaktivering innehåller alla funktioner som finns i den här underhållsversionen. Mer information finns i [Experience Manager Releases Roadmap](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html).
...
* ASSETS-24739: Inaktivera Frame.io Custom Action Endpoint vid publicering.
...
* SITES-16207: Innehållsfragment: POST /adobe/sites/cf/models-åtgärden returnerar två olika OK-statuskoder.
...
* SITES-16103: Experience Fragments: Målalternativen visas inte under Cloud Services på grund av ett konsolfel.
...
* ASSETS-28566: Lägg till Lucene-index för dam:metadataForm.
...
* ASSETS-28634: Omundersökningsfält i Adobe Stock får inte automatiskt tillagda resursdata.
...
* ASSETS-29106: Adobe Stock genererar ett fel på AEM med enhetligt gränssnitt aktiverat.
...
* ASSETS-29689: dc:roles (och den nya egenskapsdammen :roles) ska filtreras från AEM.
...
* ASSETS-30167: HTML för adobe_dam:restrictions avbryts när en resurs har överförts.
