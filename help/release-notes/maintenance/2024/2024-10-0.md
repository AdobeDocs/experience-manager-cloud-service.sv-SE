---
title: Underhållsversionsinformation om  [!DNL Adobe Experience Manager] as a Cloud Service som är kopplad till aktivering av funktioner i 2024.10.0.
description: Underhållsversionsinformation om  [!DNL Adobe Experience Manager] as a Cloud Service som är kopplad till aktivering av funktioner i 2024.10.0.
...
I följande avsnitt beskrivs den tekniska versionsinformationen för underhållsversionerna av Experience Manager as a Cloud Service som är kopplad till aktivering av funktioner i 2024.10.0.
...
* ASSETS-40482: Problem med tillgänglighet vid uppspelning/paus och knappen Stäng av/slå på i Scene7-videospelaren.
...
* ASSETS-41007: Borttagning på AEM lämnar ibland Assets vid leveransen som föräldralöst.
* ASSETS-41172: Specialtecken för dynamiska mediamallar tillåts inte i namn.
* ASSETS-41896: Assets som anges i cq:discarded-egenskapen i mappen får INTE publiceras till Brand Portal.
* ASSETS-42067: Dynamiska mediemallar - Hämtning ger fel.
* ASSETS-42070: Dynamiska mediamallar - användare som inte är administratörer bör ha behörighet att skapa/redigera mallar.
...
* ASSETS-43072: Dynamiska mediamallar - mallreferenser söker efter brytningar i en ogiltig referens.
...
* ASSETS-43502: Namnet på den befintliga bildförinställningen för AEM CS visas inte på sidan Redigera.
...
* ASSETS-38322: Aktivera http-begärandehändelse för AEM.
...
* GRANITE-50948: Integrera databastjänster i AEM Support för databastjänster.
...
* CNTBF-298: Ta bort jcr:uuid från CC-exporterade paket.
...
* GUIDES-14445: Inbyggd PDF-generering misslyckas med ett fel relaterat till hämtning av beroenden för Node.js.
* GUIDES-16961: Titeln med `<conref>` kan inte matchas på panelerna Baslinje och Översättning i webbredigeraren.
* GUIDES-17283: När du väljer alternativet **Använd metadata som lagts till i topicmeta** sprids inte metadataegenskaperna i dokumentägarna för PDF-utdata.
* GUIDES-17793: Den refererade PDF-versionen aktiveras inte från **Masspubliceringspanelen** när publicerat innehåll aktiveras gruppvis.
...
* SITES - 24833: Content Fragments: Remove the validation of HTML input into a list of allowed HTML tags.
...
* SITES - 23585: Problem med återställning av arv för komponenter med cq:responsive-nod
...
* SITES - 24025: 302 Omdirigeringar i AEM returnerar platshuvud med intern DNS i stället för offentlig DNS
