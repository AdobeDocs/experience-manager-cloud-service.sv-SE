...
I följande avsnitt beskrivs den tekniska versionsinformationen för underhållsversionerna av Experience Manager as a Cloud Service som är kopplad till aktivering av funktioner i 2024.9.0.
...
| Grundläggande komponenter i AEM | 2.26.0 | [AEM WCM Core Components](https://github.com/adobe/aem-core-wcm-components) |
...
* SKYOPS-81179: AEM bygger testning för att paketväxla.
...
* SKYOPS-83356: Skapa en global kontrollpanel för spårning av JVM-versioner som används i AEM-distributioner.
...
* CMGR-60225: Pipeline-körningsfel identifierades på AEM Sites CS-kund vid validering av uppdatering till AEM version 17486.
