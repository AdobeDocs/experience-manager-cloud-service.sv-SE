---
title: Underhållsinformation [!DNL Adobe Experience Manager] as a Cloud Service är kopplad till 2024.6.0-funktionsaktivering.
description: Underhållsinformation [!DNL Adobe Experience Manager] as a Cloud Service är kopplad till 2024.6.0-funktionsaktivering.
...
Mer information om nya och förbättrade funktioner och problem som har åtgärdats i Experience Manager Guides finns i [Experience Manager Guides release roadmap](https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/release-info/aem-guides-releases-roadmap).
