...
1. Om en användare hämtar AEM Forms SDK-versionen som är senare än `AEM Forms add-on v2024.05.04.00-240400` kan inte gruppfilen starta Docker-tjänsten. Så här löser du problemet:
   ...
   1. Ersätt de befintliga `sdk.sh`- och `sdk.bat`-filerna i AEM Forms SDK med de nya filerna.
