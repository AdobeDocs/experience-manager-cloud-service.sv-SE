---
title: Underhållsversionsinformation om  [!DNL Adobe Experience Manager] as a Cloud Service som är kopplad till aktivering av funktioner i 2024.6.0.
description: Underhållsversionsinformation om  [!DNL Adobe Experience Manager] as a Cloud Service som är kopplad till aktivering av funktioner i 2024.6.0.
...
I följande avsnitt beskrivs den tekniska versionsinformationen för underhållsversionerna av Experience Manager as a Cloud Service som är kopplad till aktivering av funktioner i 2024.6.0.
...
* ASSETS-33618: Funktioner för automatisk transkription och översättning av videor i Dynamic Media.
...
* GRANITE-51565: AEM förlorar den lokala grupprelationen till den externa gruppen när den lokala gruppen publiceras från AEM.
