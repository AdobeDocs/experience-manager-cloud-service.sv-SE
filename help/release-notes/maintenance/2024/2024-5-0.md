...
I följande avsnitt beskrivs den tekniska versionsinformationen för underhållsversionerna av Experience Manager as a Cloud Service som är kopplad till aktivering av funktioner i 2024.5.0.
...
* SITES-20342: `[Backend]` Publicera på mappnivå - lägg till filter för att bara publicera CF:er.
...
* SITES-20656: `[BE]` Ange ett alternativ för att matcha skiftläge när en sträng ersätts.
* SITES-2066: Experimentens ska vara inaktiverat som standard vid redigering.
* SITES-20752: `[cq-wcm-core]` Apple startar för CF:er.
...
* SITES-21043: `[CF][launches]` Prestandaförbättringar för sidoport i Cloud Service.
* SITES-21044: `[CF][launches]` Asynkron redigering av nyttolastsimplementering på sidan till Cloud Service.
...
* CQ-4357161: AEM Inbox Payload-skärmen returnerar 404.
...
* FORMS-14267: Användarna får konsekventa timeoutfel när de skickar API-begäranden i utvecklings-, scen- och produktionsmiljöer. Dessa begäranden är relaterade till generering av PDF-filer, ibland med data förifyllda med databindning. Säkerhetsluckan resulterar i en process som så småningom tar slut men som lyckas när du försöker igen efter felet.
...
* SITES-21233: `[CoreCmp]` Dragspel brutet för GS1 US efter uppgradering till 15860.
...
* ASSETS-26926: Förbättringar av avsökningen för Dynamic Media-överföring.
* ASSETS-30351: Dialogrutan för hämtning ska läsa in storlekar för dynamiska medieåtergivningar asynkront.
* ASSETS-30379: Förbättra upplösningen för DRM-licenser vid nedladdning.
* ASSETS-31058: Använd smarta beskärningsrenderingar i användargränssnittet för AEM-resurser på fliken för renderingar och generera smarta beskurna bilder när användaren klickar på dessa renderingar.
...
* ASSETS-34661: API för DM-förhandsgransknings- och/eller leverans-URL:er från AEMaaCS Publish.
* ASSETS-37259: Förbättrad parsning av XMP.
...
* CQ-4356992: De senaste översättningarna från AEM och Granite.
* SITES-19326: Uppdatera länkarna i Assets-gränssnittet för att öppna CF i den nya CF-redigeraren.
* SITES-20686: GraphQL - Visa URL för dynamiska media via _dmS7Url (för resurser som inte är bilder).
...
* ASSETS-37260: Export av metadata i AEM kan generera ogiltig CSV-fil.
* ASSETS-37261: PPTx och PDF Annotation Issue i AEM Assets.
* ASSETS-37282: Potentiellt långsam begäran om att öppna en stor mapp.
* ASSETS-37330: Om du importerar satsvis från OneDrive skapas en felaktig mappstruktur i AEM.
