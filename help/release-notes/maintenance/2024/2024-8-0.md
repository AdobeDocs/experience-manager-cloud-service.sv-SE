...
Funktionsaktiveringen i 2024.8.0 innehåller alla funktioner som finns i den här underhållsversionen. Mer information finns i [Experience Manager Releases Roadmap](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap).
...
* SITES-12209 - Förbättra prestanda för principredigeraren genom att lägga till cq:policy i indexet.
...
* FORMS-14327 - Forms tjänst-API:er: Extrahera data :- ger 500 svarskoder när en icke-interaktiv PDF anges i indata.
