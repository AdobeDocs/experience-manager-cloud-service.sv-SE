...
I stället för att kräva någon kodning av webbplatsen kan en innehållsförfattare konfigurera PWA-egenskaper som en extra flik i [sidegenskaperna](/help/sites-cloud/authoring/fundamentals/page-properties.md) för en plats.
...
1. Välj ditt webbplatsprojekt och välj [**Egenskaper**](/help/sites-cloud/authoring/fundamentals/page-properties.md) eller använd snabbtangenten `p`.
