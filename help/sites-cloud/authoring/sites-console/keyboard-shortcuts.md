...
|  | `/` | Anropa [sökning](/help/sites-cloud/authoring/search.md) |
|  | `Alt+`&lt;`Number`> | Växla vilket alternativ för [spårväljare](/help/sites-cloud/authoring/basic-handling.md#rail-selector) som ska visas |
|  | ``` ` ``` | Göm rälsstöd |
|  | `e` | Redigera |
|  | `p` | Egenskaper |
|  | `m` | Flytta |
...
* [Hjälp-menyn](/help/sites-cloud/authoring/basic-handling.md#accessing-help)
