...
När du har skapat och granskat ditt innehåll i författarmiljön är målet att [göra den tillgänglig på din offentliga webbplats](/help/sites-cloud/authoring/author-publish.md) (publiceringsmiljön).
...
1. I nästa steg i guiden Hantera publikation **Omfång** kan du definiera omfattningen för publikationen/avpublikationen, t.ex. inkludera underordnade sidor och/eller inkludera referenser.
   ...
   **Lägg till innehåll**
   ...
   Markera **Lägg till innehåll** knappen startar [sökvägsläsare](/help/sites-cloud/authoring/path-selection.md) för att tillåta innehållsval.
...
Om du avpublicerar en sida tas den bort från publiceringen, eller [förhandsgranska](/help/sites-cloud/authoring/sites-console/previewing-content.md), så att den inte längre är tillgänglig för läsarna.
...
1. Guiden **Hantera publikation** startar. I det första steget **Alternativ** väljer du **Avpublicera** i stället för standardalternativet **Publicera**.
   ...
   >[!NOTE]
   >Om du har en [Förhandsgranska](/help/sites-cloud/authoring/sites-console/previewing-content.md) -miljö kan du välja **Mål** under Hantera publicering.
...
* I [resursöversiktsinformation på webbplatskonsolen](/help/sites-cloud/authoring/basic-handling.md#viewing-and-selecting-resources)
...
* I [tidslinje](/help/sites-cloud/authoring/basic-handling.md#timeline)

  ![Publiceringsstatus i tidslinjevyn](/help/sites-cloud/authoring/assets/publishing-status-timeline.png)

* I [Sidinformation-menyn](/help/sites-cloud/authoring/page-editor/introduction.md#page-information) när du redigerar en sida
