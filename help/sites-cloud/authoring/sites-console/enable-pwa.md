...
I stället för att kräva någon kodning av webbplatsen kan en innehållsförfattare konfigurera PWA-egenskaper som en extra flik i [sidegenskaper](/help/sites-cloud/authoring/sites-console/page-properties.md) för en webbplats.
...
1. Välj ditt webbplatsprojekt och välj [**Egenskaper**](/help/sites-cloud/authoring/sites-console/page-properties.md) eller använda snabbtangenten `p`.
