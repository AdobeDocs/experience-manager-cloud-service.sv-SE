...
>
>* Om alternativet är aktiverat på den Adobe Target-klient (klientkod) som används på AEM-sidan för att ansluta till Adobe Target kan du `xt_only` bara **** skapa XT-aktiviteter i AEM.
   >
   >
* Om `xt_only` alternativen **inte** är aktiverade på Adobe Target-klienten (klientkod) kan du skapa **både** XT- och A/B-aktiviteter i AEM.
>
>
**** Ytterligare information: Alternativet är en inställning som används för en viss målklient (klientkod) och kan bara ändras direkt i Adobe Target. `xt_only` Du kan inte aktivera eller inaktivera det här alternativet i AEM.
...
* **** Målmotor: Antingen [AEM](/help/sites-cloud/authoring/personalization/overview.md#aem) eller [Adobe Target](/help/sites-cloud/authoring/personalization/overview.md#adobe-target) som motor för riktat innehåll.
...
1. Klicka på eller tryck på det varumärke som du skapar aktiviteten för och klicka eller tryck sedan på **Skapa** och sedan **Skapa aktivitet**. Om du redigerar markerar du aktiviteten på skärmen Huvudområde och klickar eller trycker på **Redigera aktivitet**.
