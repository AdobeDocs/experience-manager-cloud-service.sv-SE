...
Du hanterar detta i ett **område**. Områden avgränsar riktat innehåll (aktiviteter, upplevelser och erbjudanden) som används på olika webbplatser och tillhandahåller en MSM-baserad mekanism för att skapa och hantera arvet av riktat innehåll tillsammans med webbplatsarv. Detta förhindrar att du behöver återskapa riktat innehåll på ärvda webbplatser.
...
Du kan konfigurera stöd för flera webbplatser för riktat innehåll på flera olika sätt, beroende på hur det används. I det här avsnittet beskrivs hur detta teoretiskt skulle fungera med ett varumärke. I [Exempel: Innehåll som är baserat på geografi](#example-targeting-content-based-on-geography) har som mål kan du dessutom se ett verkligt program som har innehåll som mål på flera webbplatser.
...
![Exempel på flera webbplatser](/help/sites-cloud/authoring/assets/multisite-example.png)
...
![Flerplatsdiagram](/help/sites-cloud/authoring/assets/multisite-diagram.png)
...
![USA, version](/help/sites-cloud/authoring/assets/multisite-us.png)
...
![Ändrar versioner](/help/sites-cloud/authoring/assets/multisite-us-change.png)

Marknadsföraren vill sprida dessa ändringar till den europeiska regionen och [utrullar den aktiva kopian](/help/sites-cloud/administering/msm/creating-live-copies.md) genom att trycka eller klicka på **utrullningssida**. När du har uppdaterat fliken får den nya bilden på den brittiska webbplatsen när det europeiska området ärver från huvudområdet (efter utrullning).
...
>[!NOTE]
>
>Standardområdet som kallas mallområde komprimeras som standard när du väljer namnet på ett varumärke **tills du skapar ett annat område i**. När du sedan väljer ett varumärke på konsolen **Aktivitet** eller **Erbjudanden** visas konsolen **Område**.
...
1. Navigera till **Personalisering** > **Aktiviteter** eller **Erbjudanden** och sedan till ert varumärke.
1. Välj **Skapa område som Live-kopia**.
...
1. Markera området som du vill göra en live-kopia av och klicka på **Nästa**.
   ...
   ![Skapa live-kopia](/help/sites-cloud/authoring/assets/multisite-livecopy.png)
...
1. I fältet **Namn** anger du ett namn för live-kopian. Som standard inkluderas undersidor. Exkludera dem genom att markera kryssrutan **Uteslut undersidor**.
   ...
   ![Skapa live-kopia](/help/sites-cloud/authoring/assets/multisite-create-livecopy.png)
...
1. På menyn **Varumärke** väljer du det varumärke som du vill länka området till. När du har valt varumärket är tillgängliga områden tillgängliga på menyn **Områdesreferens** .
   ...
   ![Länkar webbplatser](/help/sites-cloud/authoring/assets/multisite-english.png)

1. Markera området i listrutan **Områdesreferens** och välj **Spara**.
...
1. Navigera till sidan där du vill koppla från eller göra uppehåll i arv och välj **Mål** i listrutan Läge.
...
1. Välj **Gör uppehåll** om du vill göra uppehåll i aktiviteten. Avbrutna aktiviteter markeras med rött.
...
1. Navigera till sidan där du vill koppla loss den aktiva kopian från huvudsidan och välj **Mål** i listrutan Läge.
1. Om sidan är länkad till ett område som är en live-kopia ser du arvsstatusen. Välj **Börja målinrikta**.
1. Välj **Koppla loss live-kopia** i listrutan i verktygsfältet. AEM bekräftar att du vill koppla loss live-kopian.
1. Välj **Koppla loss** om du vill frigöra den aktiva kopian från aktiviteten. När den har kopplats loss visas inte längre listrutan för arv. Aktiviteten är nu en lokal aktivitet.
...
1. Navigera till sidan där du vill återställa arv och välj **Mål** i listrutan Läge.
...
1. Välj **Återuppta** för att bekräfta att du vill återuppta live-kopiarv. Alla ändringar som gjorts i den aktuella aktiviteten går förlorade om du återupptar arvet.
