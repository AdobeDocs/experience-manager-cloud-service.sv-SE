...
* Indikatorn för [meddelande](/help/sites-cloud/authoring/inbox.md) (verktygsfältet) har ökats:

  ![Verktygsfältet Meddelande](/help/sites-cloud/authoring/assets/workflows-notifications.png)

* Objektet visas i din avisering [Inkorg](/help/sites-cloud/authoring/inbox.md):
...
* När **tidslinjen** är öppen för resursen visas arbetsflödessteget. När du väljer en varningsbanderoll visas även de tillgängliga åtgärderna:
...
1. Öppna sidan [för redigering](/help/sites-cloud/authoring/sites-console/managing-pages.md#opening-a-page-for-editing).
...
1. Markera varningsbanderollen om du vill visa tillgängliga åtgärder. Välj **Avancerat**:
...
* Fliken **INFORMATION OM ARBETSFLÖDE**:
  ...
  Om arbetsflödesfaser har konfigurerats för modellen kan du visa förloppet enligt följande: <!--If [Workflow Stages](/help/sites-developing/workflows.md#workflow-stages) have been configured for the model, you can view the progress according to these:-->
