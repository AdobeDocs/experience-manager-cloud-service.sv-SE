...
* Indikatorn för [meddelanden](/help/sites-cloud/authoring/getting-started/inbox.md) (verktygsfältet) ökar:

   ![Verktygsfältet Meddelande](/help/sites-cloud/authoring/assets/workflows-notifications.png)

* Objektet visas i din [inkorg](/help/sites-cloud/authoring/getting-started/inbox.md)för meddelanden:
...
* När du [öppnar ett arbetsflödesobjekt visas information](#opening-a-workflow-item-to-view-details-and-take-actions).
