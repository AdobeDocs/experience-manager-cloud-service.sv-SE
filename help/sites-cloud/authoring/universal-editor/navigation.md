...
För den universella redigeraren, under rubriken **Produktinställningar**, använder du alternativet **Växla till förhandsvisningsmiljö** för att växla mellan den aktuella produktionsversionen av den universella redigeraren och den kommande [förhandsvisningsversionen.](/help/release-notes/universal-editor/preview.md)
...
Som standard öppnas redigeraren så att du kan [redigera innehåll](/help/sites-cloud/authoring/universal-editor/authoring.md) på plats eller använda [egenskapspanelen.](#properties-rail)
