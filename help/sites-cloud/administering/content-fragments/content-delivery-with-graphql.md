...
The [AEM GRAPHQL API](#aem-graphql-api) gör att du kan utföra (komplexa) frågor på [Innehållsfragment](/help/sites-cloud/administering/content-fragments/overview.md); där varje fråga följer en viss modelltyp. Det returnerade innehållet kan sedan användas av dina program.
...
The **[Fragmentreferens](/help/sites-cloud/administering/content-fragments/content-fragment-models.md#fragment-reference-nested-fragments)**:
...
För att underlätta analysen finns det flera olika metoder att visa strukturen för dina fragment i AEM [Innehållsfragmentsredigerare](/help/sites-cloud/administering/content-fragments/authoring.md).

Se [Analyserar strukturen för innehållsfragment](/help/sites-cloud/administering/content-fragments/analysis.md) för mer information:
