...
* I åtgärden **Kopiera** kan du välja om du vill **kopiera med underordnade** (refererade fragment). På så sätt kan du kopiera både det markerade innehållsfragmentet och alla refererade fragment. AEM:

   * Skapar en kopia av det markerade innehållsfragmentet på dess plats.
   * Skapar kopior av alla fragment som det valda fragmentet refererar till. Dessa kopieras till samma plats som det ursprungliga refererade fragmentet.
