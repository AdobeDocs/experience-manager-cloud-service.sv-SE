...
Om du vill veta hur Adobe rekommenderar att du löser vanliga affärsärenden med AEM är det [AEM Headless Journeys](/help/journey-documentation/documentation-journeys.md) du som börjar.
...
| 3 | [Läs om hur du använder referenser i innehållsfragment](references.md) | Lär dig hur du använder referenser i innehållsfragment. Med dessa kan du också skapa och hantera flera strukturnivåer för din Headless CMS med hjälp av kapslade fragment. |
...
Nu är du redo att sätta igång med din Adobe Headless-resa. Vi rekommenderar att du fortsätter till nästa del av resan och läser artikeln [Om du skriver för AEM Headless as a Cloud Service - En introduktion](/help/journey-headless/author/introduction.md).
...
Som sådana resor är utformade för att stå på egen hand. Flera av dem kan dock vara relaterade till varandra. På de här extraresorna finns mer information om hur AEM kraftfulla funktioner fungerar tillsammans.
