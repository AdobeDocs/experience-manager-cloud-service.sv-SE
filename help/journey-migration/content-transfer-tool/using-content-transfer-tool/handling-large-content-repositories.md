...
>[!NOTE]
>För närvarande fungerar inte textrenderingar korrekt på Windows-datorer och detta är ett känt fel. Vi kommer dock att åtgärda problemet i den kommande versionen och åtgärda det.
