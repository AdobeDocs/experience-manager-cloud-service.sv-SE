...
* Observera att det finns flera olika sätt att skapa användare och gruppera i IMS.  Se [IMS-stöd för Adobe Experience Manager as a Cloud Service](/help/security/ims-support.md) om du vill veta mer om alla tillgängliga alternativ.  Här beskrivs endast Admin Console massöverföringsmetoder
* Det finns tre identitetstyper i IMS: **Adobe ID**, **Enterprise ID** och **Federated ID**. Instruktionerna på den här sidan finns endast för **Adobe ID**.  Om du behöver använda Enterprise ID eller Federated ID, se den fullständiga [Admin Console-dokumentationen](https://helpx.adobe.com/enterprise/using/admin-console.html) och även den specifika dokumentationen för [Admin Console Bulk Group-överföring](https://helpx.adobe.com/enterprise/using/user-groups.html) och [Admin Console Bulk User Upload](https://helpx.adobe.com/enterprise/using/bulk-upload-users.html).  Specifikationerna för de överförda filerna skiljer sig åt något för de två identitetstyperna
