...
* [Databasmodernisering](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/moving/refactoring-tools/repo-modernizer.html?lang=sv-SE), ett verktyg som tar ett AEM Multimode-projekt som indata och konverterar det till ett AEM as a Cloud Service-projekt
