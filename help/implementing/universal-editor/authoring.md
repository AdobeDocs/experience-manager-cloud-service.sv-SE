...
>[!TIP]
>
>En mer detaljerad introduktion till Universal Editor finns i dokumentet [Universal Editor Introduction.](introduction.md)
...
>[!TIP]
>
>Se [Komma igång med den universella redigeraren i AEM](getting-started.md) för ett exempel på hur du konfigurerar en AEM för att fungera med den universella redigeraren.
...
När du har loggat in anger du URL-adressen till sidan som du vill redigera i [platsfältet.](#location-bar) så att du kan börja redigera innehåll som [textinnehåll](#text-mode) eller [mediainnehåll.](#media-mode)
...
>[!NOTE]
>
>Alla sidor som du vill redigera med den universella redigeraren måste vara [instrumenterade för att stödja den universella redigeraren.](getting-started.md)
