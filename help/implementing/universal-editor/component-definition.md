...
* `id` identifierar komponenten unikt.
   ...
   * Eftersom den är unik kan den till exempel användas i en [filterdefinition](/help/implementing/universal-editor/customizing.md#filtering-components) för att avgöra vilka komponenter som kan läggas till i en behållare.
