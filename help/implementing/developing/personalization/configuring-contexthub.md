...
ContextHub är ett ramverk för att lagra, ändra och presentera kontextdata. Mer information om ContextHub finns i [ContextHub-utvecklaröversikt](contexthub.md).
...
1. Markera knappen Skapa och välj sedan ContextHub UI Module (generisk).
   ...
   ![Gränssnittsmodulen ContextHub](assets/contexthub-ui-module.png)
...
1. Om du vill lägga till en butik väljer du ikonen Skapa och sedan KontextHub Store Configuration.
   ...
   ![Konfiguration för ContextHub-butik](assets/contexthub-store-configuration.png)
...
Om du vill spara data från MD5-tjänsten på jsontest.com ska du göra så här i [Skapa ett ContextHub Store](#creating-a-contexthub-store) med följande egenskaper:
...
Använd proceduren i [Lägga till en gränssnittsmodul](#adding-a-ui-module) för att lägga till gränssnittsmodulen i ett befintligt gränssnittsläge, till exempel ett exempel på användargränssnittsläge. Använd följande egenskapsvärden för UI-modulen:
...
1. Välj **standardkonfigurationsbehållaren**
1. Markera **ContextHub-konfigurationen** och välj **Redigera markerat element**
1. Välj **Felsök** och välj **Spara**
...
* JCR-nod: Om du vill logga felsökningsmeddelanden ställer du in den booleska egenskapen `com.adobe.granite.contexthub.debug` på `true`.
...
* Redigera ContextHub-konfigurationen och markera alternativet **Inaktivera ContextHub**
   ...
   1. Välj **standardkonfigurationsbehållaren**
   1. Markera **ContextHub-konfigurationen** och välj **Redigera markerat element**
   1. Välj **Inaktivera ContextHub** och välj **Spara**
