...
RTE-gränssnittet har en [responsiv design](/help/sites-cloud/authoring/features/responsive-layout.md) för redigeringsmiljön. Gränssnittet är utformat för att användas på enheter med pekskärm och stationära datorer.
...
* Plugin-ID:n med en länk till API-dokumentationen. ID används som nodnamn när ett plugin-program [aktiveras](/help/implementing/developing/extending/configure-rich-text-editor-plug-ins.md#activateplugin).
