...
1. Installera Adobe I/O CLI-verktygen enligt den här [proceduren](https://developer.adobe.com/runtime/docs/guides/tools/cli_install/).
1. Installera Adobe I/O CLI tools AEM RDE plugin:
