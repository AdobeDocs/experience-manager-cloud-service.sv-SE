...
description: Versionsinformation om Cloud Manager 202.5.0 i AEM as a Cloud Service.
...
# Versionsinformation om Cloud Manager 202.5.0 i Adobe Experience Manager as a Cloud Service {#release-notes}
...
* Miljösidan har en kolumn som visar den AEM versionen av miljön.
* Vid körning av pipeline visas nu gränssnittsfel på den översta nivån på körningsskärmen.
* Kör om produktionsdistributionssteget med hjälp av Cloud Manager-gränssnittet.
