...
description: Läs om Cloud Manager 2025.12.0 i Adobe Experience Manager as a Cloud Service.
...
# Versionsinformation om Cloud Manager 2025.12.0 i Adobe Experience Manager as a Cloud Service {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

Läs om Cloud Manager 2025.12.0 i AEM (Adobe Experience Manager) as a Cloud Service.
...
Lanseringsdatumet för Cloud Manager 2025.12.0 i AEM as a Cloud Service är torsdagen den 4 december 2025.

Nästa planerade version är torsdagen den 22 januari 2026.

## Nyheter - Experience Hub {#experience-hub-whats-new}

* **Förenklad åtkomst till Experience Hub**

  Val av användarroll togs bort och en guide lades till för markering av **förinställning** (Innehållsförfattare, Resursbibliotek, Administratör och IT).

* **Meddelanden** och **Produktuppdateringar**

  Du kan växla och iterera mellan de tillgängliga meddelandena, men även stänga dem.

* **Senaste**

  Stöd för ytterligare sidor och resurser, inklusive sidredigerare, resurser, program och information om pipeline-körning, säkerhetssidor.

* **Programlista**

  Visa AEM Cloud Manager-programmen i er organisation med snabb tillgång till informationssidan för Cloud Manager.

* **AEM Guides**

  Snabbåtgärd och genväg för redigeringsmiljöer där AEM Guides-tillägg är aktiverade.
...
* **Återställ pipeline-distributioner med ett klick**

  Återgå snabbt till en tidigare distribution om den senaste kundkällkoden inte fungerar som förväntat. Du behöver inte köra hela pipelinen igen eller manuellt återställa implementeringar. <!--https://jira.corp.adobe.com/browse/CMGR-69556 -->
...
* **Självbetjäningsinstallation av WAF för Edge Delivery Services**

  När du skapar ett Edge Delivery Services-program i Cloud Manager kan du aktivera brandväggen för webbprogram (WAF). Den här inställningen skyddar din webbplats från skadlig trafik och DDoS-attacker direkt, vilket minskar det manuella installationsarbetet.
