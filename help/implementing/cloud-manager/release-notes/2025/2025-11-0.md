...
description: Läs om Cloud Manager 2025.11.0 i Adobe Experience Manager as a Cloud Service.
...
# Versionsinformation om Cloud Manager 2025.11.0 i Adobe Experience Manager as a Cloud Service {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

Läs om Cloud Manager 2025.11.0 i AEM (Adobe Experience Manager) as a Cloud Service.
...
Lanseringsdatumet för Cloud Manager 2025.11.0 i AEM as a Cloud Service är torsdagen den 6 november 2025.
...
* Nu kan du konfigurera en anpassad testmiljö på en icke-produktionspipeline via ett enklare och mer intuitivt arbetsflöde. Den strömlinjeformade installationen snabbar upp slutförandet och minskar antalet konfigurationsfel.
...
Det finns inga viktiga felkorrigeringar i Cloud Manager-versionen från november 2025.
