...
description: Läs om Cloud Manager 2026.2.0 i Adobe Experience Manager as a Cloud Service.
...
# Versionsinformation om Cloud Manager 2026.2.0 i Adobe Experience Manager as a Cloud Service {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

Läs om Cloud Manager 2026.2.0 i AEM (Adobe Experience Manager) as a Cloud Service.
...
Lanseringsdatumet för Cloud Manager 2026.2.0 i AEM as a Cloud Service är torsdagen den 5 februari 2026.
...
Det finns inga viktiga felkorrigeringar i Cloud Manager-utgåvan från februari 2026.
