...
description: Det här är versionsinformationen för Cloud Manager 2024.5.0 i AEM as a Cloud Service.
...
Lanseringsdatumet för Cloud Manager version 2024.5.0 i AEM as a Cloud Service är 9 maj 2024. Nästa version planeras till den 6 juni 2024.

## Nyheter {#what-is-new}

* [Licensinstrumentpanelen](/help/implementing/cloud-manager/license-dashboard.md) är nu tillgänglig via en distinkt startpunkt i den vänstra [navigeringen.](/help/implementing/cloud-manager/navigation.md)
