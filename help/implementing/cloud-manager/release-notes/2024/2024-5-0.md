...
* [Licensieringspanelen](/help/implementing/cloud-manager/license-dashboard.md) är nu tillgänglig via en distinkt startpunkt i den vänstra [navigeringen](/help/implementing/cloud-manager/navigation.md).
