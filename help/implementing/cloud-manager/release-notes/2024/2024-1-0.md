...
* Cloud Manager validerar nu förfallodatumen inte bara för det huvudsakliga [certifikatet,](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md), utan även för mellanliggande certifikat.
