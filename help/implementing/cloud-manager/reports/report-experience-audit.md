...
1. Om du vill använda Experience Audit när du lägger till eller redigerar en icke-produktionspipeline markerar du kryssrutan **Experience Audit** . Det här alternativet finns på fliken **Source-kod**.
   ...
   ![Aktiverar Experience Audit](/help/implementing/cloud-manager/reports/assets/experience-audit-enable.jpg)
...
1. För pipelines för både produktion och icke-produktion definierar du sökvägarna som ska inkluderas i Experience Audit på fliken **Experience Audit** .
   ...
   * Om din webbplats till exempel är `wknd.site` och vill inkludera `https://wknd.site/us/en/about-us.html` i Experience Audit anger du sökvägen `/us/en/about-us.html`.
   ...
   ![Definiera en sökväg för Experience Audit](/help/implementing/cloud-manager/reports/assets/experience-audit-add-page.png)

1. Klicka på **Lägg till sida** så fylls sökvägen automatiskt i med adressen till din miljö och läggs till i sökvägstabellen.

   ![Sparar sökvägen till tabellen](/help/implementing/cloud-manager/reports/assets/experience-audit-page-added.png)
...
![Kontrollpanel i pipeline](/help/implementing/cloud-manager/reports/assets/experience-audit-dashboard.png)
...
![Långsammast fem](/help/implementing/cloud-manager/reports/assets/experience-audit-slowest-five.png)
...
![Experience Audit-rapporter](/help/implementing/cloud-manager/reports/assets/experience-audit-reports.png)
...
![Trendinformation](/help/implementing/cloud-manager/reports/assets/experience-audit-trend-details.png)
...
![Välj en annan skanning](/help/implementing/cloud-manager/reports/assets/experience-audit-open-scan.png)
...
![Skannade sidor](/help/implementing/cloud-manager/reports/assets/experience-audit-scanned-pages.png)
...
![Raw-rapport](/help/implementing/cloud-manager/reports/assets/experience-audit-raw-reports.png)

En ny flik som öppnas i webbläsaren dirigerar dig till `https://googlechrome.github.io/lighthouse/viewer/`. Den läser automatiskt in en signerad URL-adress som innehåller JSON-rapporten för Lightroom Raw för den valda sidan, vilket möjliggör detaljerad granskning.

![Visa Raw-rapport](/help/implementing/cloud-manager/reports/assets/experience-audit-view-raw-report.png)

## Granskningsrapporter för behovsstyrd skanning {#on-demand}

Förutom att de körs under pipeline-körning kan Experience Audit-rapporter även genereras on-demand. Det här alternativet är en bra lösning för att skanna sidor snabbt utan att behöva köra en pipeline.

Om du vill köra en On-demand-skanning går du till fliken **Reports** så att du kan se hela granskningsrapporten och klickar sedan på knappen **Kör skanning** .

![On demand-skanning](/help/implementing/cloud-manager/reports/assets/experience-audit-on-demand.png)

Knappen **Kör skanning** blir inte tillgänglig och har en klockikon när en skanning på begäran redan körs.

![On demand-skanning körs](/help/implementing/cloud-manager/reports/assets/experience-audit-on-demand-running.png)
...
![Utlösarfilter](/help/implementing/cloud-manager/reports/assets/experience-audit-on-demand-trigger.png)
...
![Problem som påträffades av Experience Audit](/help/implementing/cloud-manager/reports/assets/experience-audit-issues.png)
...
![Fullständiga rapportproblem](/help/implementing/cloud-manager/reports/assets/experience-audit-issues-report.png)
...
* Sidorna som visas i den nedrullningsbara listan **Select** i [**Sidpoäng - trend** section](#trend) är alla kända sidor som Experience Audit har skannat in tidigare.
